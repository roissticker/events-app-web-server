...
//        e.g https://github.com/roissticker/events-app-web-server might become https://github.com/MyName/external.git
// variables:
...
//      https://github.com/roissticker/events-app-web-server
//      roissticker
//      web-server-image
//      roissticker-1 
...
pipeline {
   ...
   environment {
        ...
        imageName = 'roissticker/web-server-image'
        dockerImage = ''
        }
    stages {
        stage('Run the tests') {
            ...
            steps {
                ...
                git branch: 'master',
                    url: 'https://github.com/roissticker/events-app-web-server'
